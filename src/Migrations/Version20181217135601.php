 ...
 */
final class Version20181217135601 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE collection (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, politicid_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_FC4D653258E0A285 (userid_id), INDEX IDX_FC4D6532A69A7486 (politicid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
